...
export default function Footer() {
  ...
  return (
    <footer style={{ background: "#111", color: "#fff", fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "60px 40px 0" }}>
        ...
        {/* Main 3-column grid */}
        <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1fr 0.8fr", gap: 60, paddingBottom: 48, borderBottom: "1px solid rgba(255,255,255,0.1)" }}>
          ...
          <div>
            ...
            {subbed ? (
              <p style={{ fontSize: "0.85rem", color: "#C6A664" }}>Thank you for subscribing!</p>
            ) : (
              <form onSubmit={(e) => { e.preventDefault(); if (email) setSubbed(true); }}
                ...
                <input
                  ...
                  style={{
                    ...
                    padding: "11px 16px", fontSize: "0.8rem", color: "#fff",
                ...
                <button type="submit" style={{
                  ...
                  onMouseEnter={e => {
                    (e.currentTarget as HTMLButtonElement).style.background = "#C6A664";
                    (e.currentTarget as HTMLButtonElement).style.borderColor = "#C6A664";
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0 24px" }}>
              ...
              <div>
                ...
                <p style={{ fontSize: "0.82rem", color: "rgba(255,255,255,0.65)", marginBottom: 4 }}>reservations@aurumpalace.com</p>
              </div>
